...
urlpatterns = [
    path('5cdba533cc0c408b1d7bb5e8c9b00b01b691e3e25cdba533cc0c408b1d7bb5e8c9b00b01b691e3e2/', admin.site.urls), # SHA1_Hash(threat-track/admin) * 2 = 5cdba533cc0c408b1d7bb5e8c9b00b01b691e3e2
...
if settings.DEBUG and settings.MEDIA_STORAGE_TYPE == 'LOCAL':
