...
urlpatterns = [
    ...
    path(
        "clients/<int:client_id>/debug", views.debug_diffusion, name="debug_diffusion"
    ),
    ...
    path(
        ...
        views.vulnerability_delete,
        name="vulnerability_delete",
    ),
    path(
        "vulnerabilities/<int:vulnerability_id>",
        views.vulnerability_info,
