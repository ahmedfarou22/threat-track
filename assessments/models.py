...
class Assessment(models.Model):
    ...
    priority = models.ForeignKey(
        "AssessmentPriority", on_delete=models.SET_NULL, null=True, blank=True
    )
    ...
    status = models.ForeignKey(
        "AssessmentStatus", on_delete=models.SET_NULL, null=True, blank=True
    )

    assigned_users = models.ManyToManyField(
        User, related_name="assigned_assessments", blank=True
    )

    vulnerabilities = models.ManyToManyField(
        "AssessmentVulnerability",
        related_name="vulnerabilities_assessments",
        blank=True,
    )

    files = models.ManyToManyField(
        "AssessmentFile", related_name="assessments", blank=True
    )
    tasks = models.ManyToManyField(
        "AssessmentTask", related_name="assessments", blank=True
    )

    # for dynamic fileds (Assessment structure)
    assessment_structure = models.ForeignKey(
        "assessment_structures.Assessment_Structure",
        on_delete=models.SET_NULL,
        null=True,
        blank=True,
        related_name="assessments",
...
class AssessmentVulnerability(models.Model):
    assessment = models.ForeignKey(
        Assessment, on_delete=models.CASCADE, related_name="vulnerabilities_w"
    )
    ...
    poc_screenshots = models.ManyToManyField(
        "VulnerabilityScreenshot", related_name="vulnerabilities", blank=True
    )
...
class VulnerabilityScreenshot(models.Model):
    vulnerability = models.ForeignKey(
        AssessmentVulnerability, on_delete=models.CASCADE, related_name="screenshots"
    )
